...
class ReviewForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {'name':forms.TextInput(attrs={'class':'form-control', 'placeholder':'Enter Your Name'}), 'review':forms.TextInput(attrs={'class':'form-control', 'placeholder':'Enter Your Reviews'}), 'rating':forms.TextInput(attrs={'class':'form-control', 'placeholder':'Enter Your Rating Out of 5'})}
